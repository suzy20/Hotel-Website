	...
	<tr>
		<td>
			<div style="position:relative;">
				<img alt="" src="resources/image/room/standard1.jpg" width="600px" height="300px" onclick="location.href='room_detail.do'">
		...
		<td>
			<div style="position:relative;">
				<img alt="" src="resources/image/room/standard2.jpg" width="600px" height="300px" >
				<div style="position:absolute; top:70%; left:10%; color:#FFFFFF;">
